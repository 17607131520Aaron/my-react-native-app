...
import CodeScanner from '~/components/CodeScannerV1.2';

import { styles } from './index.style';

import type { IScanResult } from '~/components/CodeScannerV1.2';
import type { IWithNavigationBarProps } from '~/components/shared/NavigationBar/withNavigationBar';
    ...
    <SafeAreaView edges={['bottom']} style={styles.container}>
      ...
      <View style={styles.scannerContainer}>
        <CodeScanner
          ...
          quickScanConfig={{
            scanInterval: 200, // 快速模式扫码间隔 200ms
            recognitionFrameDuration: 300, // 识别框显示 300ms
            vibrationPattern: [20], // 轻微震动
          }}
          style={styles.scanner}
          torchMode={torchMode}
          vibrationConfig={{
            successPattern: [50], // 成功震动
            duplicatePattern: [30, 50, 30], // 重复扫码震动
            errorPattern: [200], // 错误震动
          }}
